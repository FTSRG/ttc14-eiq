...
\cite{IMDB2EMF}. The pre-parsed IMDb models are available on request. The
transformation case will use synthetic data (as generated in Task~1) as well as
real IMDB data for the evaluation of the correctness and performance of the
submitted solutions.
