...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.ttc.imdb.movies.Root} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RootItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MoviesPackage.Literals.ROOT__CHILDREN);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MoviesPackage.Literals.ROOT__CHILDREN,
				 MoviesFactory.eINSTANCE.createContainedElement()));

		newChildDescriptors.add
			(createChildParameter
				(MoviesPackage.Literals.ROOT__CHILDREN,
				 MoviesFactory.eINSTANCE.createActor()));

		newChildDescriptors.add
			(createChildParameter
				(MoviesPackage.Literals.ROOT__CHILDREN,
				 MoviesFactory.eINSTANCE.createActress()));

		newChildDescriptors.add
			(createChildParameter
				(MoviesPackage.Literals.ROOT__CHILDREN,
				 MoviesFactory.eINSTANCE.createCouple()));

		newChildDescriptors.add
			(createChildParameter
				(MoviesPackage.Literals.ROOT__CHILDREN,
				 MoviesFactory.eINSTANCE.createMovie()));

		newChildDescriptors.add
			(createChildParameter
				(MoviesPackage.Literals.ROOT__CHILDREN,
				 MoviesFactory.eINSTANCE.createClique()));
	}
