...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.ttc.imdb.movies.Person} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Person_movies_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Person_movies_feature", "_UI_Person_type"),
				 MoviesPackage.Literals.PERSON__MOVIES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MoviesPackage.Literals.PERSON__NAME,
				 true,
				 false,
				 false,
