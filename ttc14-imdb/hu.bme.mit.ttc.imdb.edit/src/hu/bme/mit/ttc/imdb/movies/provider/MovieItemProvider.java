...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.ttc.imdb.movies.Movie} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Movie_persons_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Movie_persons_feature", "_UI_Movie_type"),
				 MoviesPackage.Literals.MOVIE__PERSONS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addYearPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Movie_year_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Movie_year_feature", "_UI_Movie_type"),
				 MoviesPackage.Literals.MOVIE__YEAR,
				 true,
				 false,
				 false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Movie_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Movie_type_feature", "_UI_Movie_type"),
				 MoviesPackage.Literals.MOVIE__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
