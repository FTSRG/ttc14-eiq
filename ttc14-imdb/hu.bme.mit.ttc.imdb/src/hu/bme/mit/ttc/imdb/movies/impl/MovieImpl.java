/**
 */
package hu.bme.mit.ttc.imdb.movies.impl;

import hu.bme.mit.ttc.imdb.movies.Movie;
import hu.bme.mit.ttc.imdb.movies.MovieType;
 ...
 * <ul>
 *   <li>{@link hu.bme.mit.ttc.imdb.movies.impl.MovieImpl#getPersons <em>Persons</em>}</li>
 *   <li>{@link hu.bme.mit.ttc.imdb.movies.impl.MovieImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link hu.bme.mit.ttc.imdb.movies.impl.MovieImpl#getRating <em>Rating</em>}</li>
 *   <li>{@link hu.bme.mit.ttc.imdb.movies.impl.MovieImpl#getYear <em>Year</em>}</li>
 *   <li>{@link hu.bme.mit.ttc.imdb.movies.impl.MovieImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
